...
export class JhiAlertErrorComponent implements OnDestroy {
    ...
    constructor(private alertService: AlertService, @Inject('$rootScope') private $rootScope, private translateService: TranslateService) {
        ...
        this.cleanHttpErrorListener = $rootScope.$on('myappApp.httpError', (event, httpResponse) => {
            var i;
                ...
                case 400:
                    ...
                    if (errorHeader) {
                        ...
                        for (i = 0; i < httpResponse.data.fieldErrors.length; i++) {
                            ...
                            var fieldName = translateService.instant('myappApp.' + fieldError.objectName + '.' + convertedField);
